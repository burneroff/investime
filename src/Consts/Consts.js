export const dataEvent = [
   ...
   export const dataAttraction = [
        ...
        },
        {
          ...
          rating: 4.9,
          description: 'Алмаз знаний, внутри которого читателям и простым туристам доступны 10 миллионов экземпляров в виде рукописей, книг, газет и других бумажных носителей.',
          price: 10,
        ...
        { 
          ...
          { 
            ...
            rating: 4.8, 
            description: 'Легенда самого знаменитого католического храма Минска весьма трогательная. Сейчас в храме проводятся мессы на белорусском и польском языках и его можно посетить в рамках экскурсии.', 
            price: 30, 
          ...
          { 
            ...
            rating: 4.2, 
            description: 'Vulica Brazil» — фестиваль граффити-культуры, — подарил городу не только парочку запоминающихся вечеров музыки и южноамериканской культуры.', 
            price: 5,
          ...
          { 
            ...
            rating: 4.8, 
            description: 'Своеобразный монополист от мира искусства: единственный оперный театр в Беларуси и по совместительству самый большой в стране.', 
            price: 45, 
